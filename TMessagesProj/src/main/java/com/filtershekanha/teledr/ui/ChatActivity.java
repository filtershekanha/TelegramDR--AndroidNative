...
import com.filtershekanha.teledr.messenger.DownloadController;
import com.filtershekanha.teledr.messenger.Emoji;
import com.filtershekanha.teledr.messenger.EmojiSuggestion;
import com.filtershekanha.teledr.messenger.FileLoader;
import com.filtershekanha.teledr.messenger.FileLog;
import com.filtershekanha.teledr.messenger.ImageReceiver;
import com.filtershekanha.teledr.messenger.LocaleController;
import com.filtershekanha.teledr.messenger.MediaController;
...
import com.filtershekanha.teledr.messenger.NotificationsController;
import com.filtershekanha.teledr.messenger.R;
import com.filtershekanha.teledr.messenger.SecretChatHelper;
import com.filtershekanha.teledr.messenger.SendMessagesHelper;
...
import com.filtershekanha.teledr.messenger.VideoEditedInfo;
import com.filtershekanha.teledr.messenger.browser.Browser;
import com.filtershekanha.teledr.messenger.exoplayer2.ui.AspectRatioFrameLayout;
import com.filtershekanha.teledr.messenger.support.SparseLongArray;
import com.filtershekanha.teledr.messenger.support.widget.GridLayoutManager;
import com.filtershekanha.teledr.messenger.support.widget.GridLayoutManagerFixed;
...
import com.filtershekanha.teledr.ui.ActionBar.ActionBarLayout;
...
import com.filtershekanha.teledr.ui.ActionBar.BackDrawable;
import com.filtershekanha.teledr.ui.ActionBar.BaseFragment;
import com.filtershekanha.teledr.ui.ActionBar.BottomSheet;
import com.filtershekanha.teledr.ui.ActionBar.SimpleTextView;
import com.filtershekanha.teledr.ui.ActionBar.Theme;
import com.filtershekanha.teledr.ui.ActionBar.ThemeDescription;
import com.filtershekanha.teledr.ui.Adapters.MentionsAdapter;
import com.filtershekanha.teledr.ui.Adapters.StickersAdapter;
import com.filtershekanha.teledr.ui.Cells.BotHelpCell;
import com.filtershekanha.teledr.ui.Cells.BotSwitchCell;
import com.filtershekanha.teledr.ui.Cells.ChatActionCell;
import com.filtershekanha.teledr.ui.Cells.ChatLoadingCell;
import com.filtershekanha.teledr.ui.Cells.ChatMessageCell;
import com.filtershekanha.teledr.ui.Cells.ChatUnreadCell;
import com.filtershekanha.teledr.ui.Cells.CheckBoxCell;
import com.filtershekanha.teledr.ui.Cells.ContextLinkCell;
import com.filtershekanha.teledr.ui.Cells.MentionCell;
import com.filtershekanha.teledr.ui.Cells.StickerCell;
...
import com.filtershekanha.teledr.ui.Components.ChatAttachAlert;
import com.filtershekanha.teledr.ui.Components.ChatAvatarContainer;
import com.filtershekanha.teledr.ui.Components.ChatBigEmptyView;
import com.filtershekanha.teledr.ui.Components.CombinedDrawable;
import com.filtershekanha.teledr.ui.Components.CorrectlyMeasuringTextView;
import com.filtershekanha.teledr.ui.Components.EmbedBottomSheet;
import com.filtershekanha.teledr.ui.Components.EmojiView;
import com.filtershekanha.teledr.ui.Components.ExtendedGridLayoutManager;
import com.filtershekanha.teledr.ui.Components.FragmentContextView;
import com.filtershekanha.teledr.ui.Components.InstantCameraView;
import com.filtershekanha.teledr.ui.Components.LayoutHelper;
import com.filtershekanha.teledr.ui.Components.NumberTextView;
import com.filtershekanha.teledr.ui.Components.PipRoundVideoView;
...
import com.filtershekanha.teledr.ui.Components.ShareAlert;
import com.filtershekanha.teledr.ui.Components.Size;
...
import com.filtershekanha.teledr.ui.Components.TypefaceSpan;
import com.filtershekanha.teledr.ui.Components.URLSpanBotCommand;
import com.filtershekanha.teledr.ui.Components.URLSpanMono;
import com.filtershekanha.teledr.ui.Components.URLSpanNoUnderline;
import com.filtershekanha.teledr.ui.Components.URLSpanReplacement;
import com.filtershekanha.teledr.ui.Components.URLSpanUserMention;
                    ...
                    if ((index = animatingMessageObjects.indexOf(message)) != -1) {
                        ...
                        messageCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                com.filtershekanha.teledr.ui.Components.Rect rect = instantCameraView.getCameraRect();
