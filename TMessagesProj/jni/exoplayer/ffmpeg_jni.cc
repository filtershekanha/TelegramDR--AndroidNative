...
#define DECODER_FUNC(RETURN_TYPE, NAME, ...) \
  JNIEXPORT RETURN_TYPE Java_com_filtershekanha_teledr_messenger_exoplayer2_ext_ffmpeg_FfmpegDecoder_##NAME(JNIEnv* env, jobject thiz, ##__VA_ARGS__)

#define LIBRARY_FUNC(RETURN_TYPE, NAME, ...) \
  JNIEXPORT RETURN_TYPE Java_com_filtershekanha_teledr_messenger_exoplayer2_ext_ffmpeg_FfmpegLibrary_##NAME(JNIEnv* env, jobject thiz, ##__VA_ARGS__)
