...
import com.filtershekanha.teledr.messenger.exoplayer2.ExoPlayerLibraryInfo;
import com.filtershekanha.teledr.messenger.exoplayer2.ParserException;
import com.filtershekanha.teledr.messenger.exoplayer2.Timeline;
import com.filtershekanha.teledr.messenger.exoplayer2.source.BaseMediaSource;
import com.filtershekanha.teledr.messenger.exoplayer2.source.CompositeSequenceableLoaderFactory;
import com.filtershekanha.teledr.messenger.exoplayer2.source.DefaultCompositeSequenceableLoaderFactory;
...
import com.filtershekanha.teledr.messenger.exoplayer2.source.MediaSourceEventListener;
import com.filtershekanha.teledr.messenger.exoplayer2.source.MediaSourceEventListener.EventDispatcher;
import com.filtershekanha.teledr.messenger.exoplayer2.source.SequenceableLoader;
import com.filtershekanha.teledr.messenger.exoplayer2.source.ads.AdsMediaSource;
import com.filtershekanha.teledr.messenger.exoplayer2.source.dash.PlayerEmsgHandler.PlayerEmsgCallback;
import com.filtershekanha.teledr.messenger.exoplayer2.source.dash.manifest.DashManifest;
import com.filtershekanha.teledr.messenger.exoplayer2.source.dash.manifest.DashManifestParser;
import com.filtershekanha.teledr.messenger.exoplayer2.source.dash.manifest.UtcTimingElement;
import com.filtershekanha.teledr.messenger.exoplayer2.upstream.Allocator;
import com.filtershekanha.teledr.messenger.exoplayer2.upstream.DataSource;
import com.filtershekanha.teledr.messenger.exoplayer2.upstream.Loader;
import com.filtershekanha.teledr.messenger.exoplayer2.upstream.LoaderErrorThrower;
import com.filtershekanha.teledr.messenger.exoplayer2.upstream.ParsingLoadable;
import com.filtershekanha.teledr.messenger.exoplayer2.util.Assertions;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  public static final class Factory implements AdsMediaSource.MediaSourceFactory {
     ...
     * com.filtershekanha.teledr.messenger.exoplayer2.Timeline} of the source as {@link
     * com.filtershekanha.teledr.messenger.exoplayer2.Timeline.Window#tag}.
     *
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
        com.filtershekanha.teledr.messenger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      com.filtershekanha.teledr.messenger.exoplayer2.source.dash.manifest.Period period =
