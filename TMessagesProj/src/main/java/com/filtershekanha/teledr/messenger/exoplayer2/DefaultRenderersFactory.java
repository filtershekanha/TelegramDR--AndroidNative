...
import com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioCapabilities;
import com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioProcessor;
import com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioRendererEventListener;
import com.filtershekanha.teledr.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
...
import com.filtershekanha.teledr.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import com.filtershekanha.teledr.messenger.exoplayer2.metadata.MetadataOutput;
import com.filtershekanha.teledr.messenger.exoplayer2.metadata.MetadataRenderer;
import com.filtershekanha.teledr.messenger.exoplayer2.text.TextOutput;
import com.filtershekanha.teledr.messenger.exoplayer2.text.TextRenderer;
import com.filtershekanha.teledr.messenger.exoplayer2.trackselection.TrackSelector;
import com.filtershekanha.teledr.messenger.exoplayer2.video.MediaCodecVideoRenderer;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.filtershekanha.teledr.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              boolean.class,
              long.class,
              android.os.Handler.class,
              com.filtershekanha.teledr.messenger.exoplayer2.video.VideoRendererEventListener.class,
              int.class);
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.filtershekanha.teledr.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioRendererEventListener.class,
              com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioProcessor[].class);
      // LINT.ThenChange(../../../../../../../proguard-rules.txt)
      Renderer renderer =
    ...
    try {
      // Full class names used for constructor args so the LINT rule triggers if any of them move.
      // LINT.IfChange
      Class<?> clazz = Class.forName("com.filtershekanha.teledr.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioRendererEventListener.class,
    ...
    try {
      ...
      // LINT.IfChange
      Class<?> clazz =
          Class.forName("com.filtershekanha.teledr.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor =
          clazz.getConstructor(
              android.os.Handler.class,
              com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioRendererEventListener.class,
