...
static const char *FileLoadOperationClassPathName = "com/filtershekanha/teledr/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "com/filtershekanha/teledr/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "com/filtershekanha/teledr/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(IJLcom/filtershekanha/teledr/tgnet/RequestDelegateInternal;Lcom/filtershekanha/teledr/tgnet/QuickAckDelegate;Lcom/filtershekanha/teledr/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/filtershekanha/teledr/tgnet/RequestTimeDelegate;)J", (void *) checkProxy}
};
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("com/filtershekanha/teledr/tgnet/RequestDelegateInternal"));
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("com/filtershekanha/teledr/tgnet/RequestTimeDelegate"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("com/filtershekanha/teledr/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("com/filtershekanha/teledr/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("com/filtershekanha/teledr/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("com/filtershekanha/teledr/tgnet/ConnectionsManager"));
