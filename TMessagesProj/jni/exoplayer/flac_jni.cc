...
RETURN_TYPE Java_com_filtershekanha_teledr_messenger_exoplayer2_ext_flac_FlacDecoderJni_##NAME(JNIEnv *env, jobject thiz, ##__VA_ARGS__)
...
DECODER_FUNC(jobject, flacDecodeMetadata, jlong jContext) {
  ...
  jclass cls = env->FindClass("com/filtershekanha/teledr/messenger/exoplayer2/util/FlacStreamInfo");
