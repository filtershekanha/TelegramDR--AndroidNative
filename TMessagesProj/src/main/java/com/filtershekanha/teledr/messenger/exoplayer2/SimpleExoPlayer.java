...
import com.filtershekanha.teledr.messenger.exoplayer2.analytics.AnalyticsCollector;
import com.filtershekanha.teledr.messenger.exoplayer2.analytics.AnalyticsListener;
import com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioAttributes;
import com.filtershekanha.teledr.messenger.exoplayer2.audio.AudioRendererEventListener;
import com.filtershekanha.teledr.messenger.exoplayer2.decoder.DecoderCounters;
import com.filtershekanha.teledr.messenger.exoplayer2.drm.DefaultDrmSessionManager;
import com.filtershekanha.teledr.messenger.exoplayer2.drm.DrmSessionManager;
import com.filtershekanha.teledr.messenger.exoplayer2.drm.FrameworkMediaCrypto;
import com.filtershekanha.teledr.messenger.exoplayer2.metadata.Metadata;
import com.filtershekanha.teledr.messenger.exoplayer2.metadata.MetadataOutput;
import com.filtershekanha.teledr.messenger.exoplayer2.source.MediaSource;
import com.filtershekanha.teledr.messenger.exoplayer2.source.TrackGroupArray;
import com.filtershekanha.teledr.messenger.exoplayer2.text.Cue;
import com.filtershekanha.teledr.messenger.exoplayer2.text.TextOutput;
import com.filtershekanha.teledr.messenger.exoplayer2.trackselection.TrackSelectionArray;
import com.filtershekanha.teledr.messenger.exoplayer2.trackselection.TrackSelector;
import com.filtershekanha.teledr.messenger.exoplayer2.util.Clock;
import com.filtershekanha.teledr.messenger.exoplayer2.util.Util;
import com.filtershekanha.teledr.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class SimpleExoPlayer implements ExoPlayer, Player.VideoComponent, Player.TextComponent {
  ...
  /** @deprecated Use {@link com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener listener) {
    videoListeners.add(listener);
  }

  @Override
  public void removeVideoListener(com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener listener) {
   ...
   * @deprecated Use {@link #addVideoListener(com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener)}.
   */
  @Deprecated
  ...
  private final class ComponentListener implements VideoRendererEventListener,
    ...
    public void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees,
      ...
      for (com.filtershekanha.teledr.messenger.exoplayer2.video.VideoListener videoListener : videoListeners) {
